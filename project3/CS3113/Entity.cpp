...
Entity::Entity():  mPosition{0.0f, 0.0f}, mMovement{0.0f, 0.0f},
                   ...
                   mTexture{Texture2D{}}, mTextureType{SINGLE}, mAngle{0.0f},
                   mSpriteSheetDimensions{}, mDirection{RIGHT},
                   mAnimationAtlas{{}}, mAnimationIndices{}, mFrameSpeed{0},
                   mSpeed{DEFAULT_SPEED}, mJumpingPower{0.0f},
                   mIsJumping{false}, mEntityStatus{ACTIVE},
                   mIsCollidingTop{false}, mIsCollidingBottom{false},
                   mIsCollidingLeft{false}, mIsCollidingRight{false},
                   mAnimationTime{0.0f}, mCurrentFrameIndex{0}{ }

Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath): 
        mPosition{position}, mMovement{0.0f, 0.0f},
        mVelocity{0.0f, 0.0f}, mAcceleration{0.0f, 0.0f},
        mScale{scale}, mColliderDimensions{scale},
        mTexture{LoadTexture(textureFilepath)}, mTextureType{SINGLE}, mAngle{0.0f},
        mSpriteSheetDimensions{}, mDirection{RIGHT},
        mAnimationAtlas{{}}, mAnimationIndices{}, mFrameSpeed{0},
        mSpeed{DEFAULT_SPEED}, mJumpingPower{0.0f},
        mIsJumping{false}, mEntityStatus{ACTIVE},
...
Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath,TextureType textureType, Vector2 spriteSheetDimensions,
               std::map<Direction, std::vector<int>> animationAtlas)
               : mPosition{position}, mMovement{0.0f, 0.0f},
               mVelocity{0.0f, 0.0f}, mAcceleration{0.0f, 0.0f},
               mScale{scale}, mColliderDimensions{scale},
               mTexture{LoadTexture(textureFilepath)}, mTextureType{textureType}, mAngle{0.0f},
               mSpriteSheetDimensions{spriteSheetDimensions}, mDirection{RIGHT},
               mAnimationAtlas{animationAtlas}, mAnimationIndices{animationAtlas.at(RIGHT)},
