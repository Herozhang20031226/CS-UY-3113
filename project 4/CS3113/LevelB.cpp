...
{
   mGameState.levelID     = 2;
   mGameState.nextSceneID = -1;

   mGameState.bgm = LoadMusicStream("assets/game/level2.mp3");
   ...
   */
   ...
   // here I create the entity for the follower AI
   ...
   follower->setColliderDimensions({
      follower->getScale().x / 9.5f,
      follower->getScale().y / 1.2f
   });
